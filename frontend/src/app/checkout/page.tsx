          ...
          <div className="bg-white rounded-lg shadow-md p-6 h-fit">
            ...
            <div className="space-y-3 mb-4">
              {cart?.items.map((item: any) => (
                <div key={item.id} className="flex items-center gap-3">
                  ...
                  <span className="font-medium text-sm">৳{item.subtotal.toLocaleString()}</span>
                </div>
              ))}
            </div>
            ...
            <div className="border-t pt-4 mb-4">
              ...
              <div className="flex gap-2">
                <input
                  ...
                  className="flex-1 px-3 py-2 border rounded-lg text-sm font-mono focus:outline-none focus:ring-2 focus:ring-primary-500"
                />
              </div>
            </div>
            ...
            <div className="border-t pt-4 space-y-2">
              ...
              <div className="flex justify-between">
                ...
                <span>৳{cart?.delivery_charge || 60}</span>
              </div>
              {cart?.discount_amount > 0 && (
                <div className="flex justify-between text-green-600">
                  <span>Discount</span>
                  <span>-৳{cart.discount_amount.toLocaleString()}</span>
                </div>
              )}
            </div>
            ...
            <div className="border-t mt-4 pt-4">
              <div className="flex justify-between text-lg font-bold">
                <span>Total</span>
                <span className="text-primary-600">৳{cart?.total?.toLocaleString() || ((cart?.subtotal || 0) + (cart?.delivery_charge || 60)).toLocaleString()}</span>
              </div>
            </div>
